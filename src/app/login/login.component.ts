...
export class LoginComponent implements OnInit{
  ...
  constructor(private angularAuth: AngularFireAuth, private authService: AuthService, private router: Router, private _ngZone: NgZone, private service: AuthService, public _dataService: DataService) {}
